...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-1 text-left align-middle font-medium text-white/70 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("py-4 px-2 align-middle text-white/90 [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
